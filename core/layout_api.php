...
function layout_footer() {
	...
	echo '<address>' . "\n";
	echo '<strong>Powered by <a href="https://mantisbt.org" title="bug tracking software">MantisBT ' . $t_version_suffix . '</a></strong>' ;
	echo '<strong>Customized by <a href="https://coopbankoromia.com.et/" title="bug tracking software">COOP' . $t_version_suffix . '</a></strong> <br>' . "\n";
	...
	if( !is_page_name( 'login_page' ) ) {
		...
		echo '<a href="https://coopbankoromia.com.et/" '.
			'title="COOP Bug Tracker: official coop web based bug tracking system.">' .
			'<img src="' . $t_mantisbt_logo_url . '" width="160" height="80" ' .
			'alt="Powered by COOP Tracker: aofficial web based bug tracking system." />' .
			'</a>' . "\n";
		echo '</div>' . "\n";
		echo '</div>' . "\n";
	}
