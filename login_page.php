...
<div class="position-relative">
	...
	<form id="login-form" method="post" action="<?php echo AUTH_PAGE_CREDENTIAL ?>">
		<fieldset>
			...
			<input type="submit" class="width-40 pull-right btn btn-primary bigger-110" value="<?php echo lang_get( 'login' ) ?>" />
		</fieldset>
	</form>
...
if( $t_show_anonymous_login || $t_show_signup ) {
	...
	if( $t_show_signup ) {
		echo '<a class="back-to-login-link pull-right" href="signup_page.php">', lang_get( 'signup_link' ), '</a>';
	}
